...
public class BeanHelperTest {
	...
	public void testClazzList() throws Exception{
		...
		Method method = clz.getDeclaredMethod("clazzList",Object.class,BeanHelper.ParentOpt.class);
		method.setAccessible(true);
		TestModel m = new TestModel();
		List<Class<?>> res =  (List<Class<?>>) method.invoke(null, m,BeanHelper.ParentOpt.ALL);
		System.out.println("ALL:"+res);
		res =  (List<Class<?>>) method.invoke(null, m,BeanHelper.ParentOpt.ALLPARENT);
